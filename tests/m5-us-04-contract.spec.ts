...
describe('M5-US-04 Sandbox Pilot contracts after M9 supersession', () => {
  it('keeps pilot phases while retiring the sandbox funding provider contract', () => {
    ...
    expect(productionEnv).toContain("['CORE_ORDER', 'CORE_ORDER_AND_GIFTS', 'OFF']");
    expect(productionEnv).not.toContain('REPORTS_AND_PROFILES');
    ...
    expect(productionEnv).toContain('CORE_ORDER_AND_GIFTS');
