...
describe('M3-US-01 Discord gift panel', () => {
  test('renders API affordability and recharge action without accepting a receiver input', () => {
    const panel = buildGiftPanel({
      ...
      balance: { ledgerBalanceMinor: 5000, reservedMinor: 3000, availableMinor: 2000, currency: 'USD', calculatedAt: '2026-07-18T12:00:00.000Z' },
      items: [
        { id: 'gift-18', code: 'SMALL', name: '小心意', version: 1, priceMinor: 1800, currency: 'USD', affordable: true },
        { id: 'gift-88', code: 'BOX', name: '礼盒', version: 1, priceMinor: 8800, currency: 'USD', affordable: false }
      ]
    });
  ...
  test('confirms that funds are reserved and staff review is pending', () => {
    expect(buildGiftRequestConfirmation({
      ...
      gift: { code: 'SMALL', name: '小心意', priceMinor: 1800, currency: 'USD' },
      reservation: { id: 'reservation-1', sourceType: 'GIFT', status: 'ACTIVE', amountMinor: 1800, currency: 'USD', expiresAt: '2026-07-18T12:30:00.000Z' },
      staffTask: { id: 'task-1', publicId: 'T-1', type: 'GIFT_REVIEW', status: 'OPEN' },
      balance: { ledgerBalanceMinor: 5000, reservedMinor: 4800, availableMinor: 200, currency: 'USD', calculatedAt: '2026-07-18T12:00:00.000Z' }
