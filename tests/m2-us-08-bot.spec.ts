...
const workbench: PlayerWorkbenchSummary = {
  ...
  matchingOrders: [{
    ...
    order: {
      ...
      currency: 'CNY', requirements: ['中文交流'], voiceChannelId: null
    }
  }],
  earningsSummary: { pendingMinor: 8_000, confirmedMinor: 3_000, paidMinor: 20_000, currency: 'CNY', calculatedAt: '2026-07-18T00:00:00.000Z' },
...
describe('M2-US-08 Sapphire player workbench', () => {
  test('renders the API projection without recomputing eligibility or actions in the Bot', () => {
    ...
    expect(message.body).toContain('预计收益：¥80.00');
