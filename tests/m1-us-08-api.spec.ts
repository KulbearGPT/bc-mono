...
describe('M1-US-08 reusable internal reservation lifecycle',()=>{
  test('release restores available balance and appends no debit',async()=>{
    ...
    await service.createTopUp({userId,amountMinor:500,paymentChannel:'CASH',externalTransactionId:'m1_08',paidAt:now.toISOString(),note:'verified',idempotencyKey:'m1:08:t',actorStaffId:'00000000-0000-0000-0000-000000001821',actorLevel:'L2_SUPERVISOR',now});
