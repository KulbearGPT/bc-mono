    ...
    await expect(
      createServiceCatalogVersion({
        ...
        input: {
          ...
          billingUnitMinutes: 60,
          minimumUnits: 1,
          customerUnitPrice: { amountMinor: 6000, currency: 'USD' },
          playerUnitPayout: { amountMinor: 4200, currency: 'USD' },
          enabled: true,
    ...
    const replacement = await updateServiceCatalogVersion({
      ...
      input: {
        ...
        replacement: {
          ...
          billingUnitMinutes: 60,
          minimumUnits: 1,
          customerUnitPrice: { amountMinor: 7200, currency: 'USD' },
          playerUnitPayout: { amountMinor: 5000, currency: 'USD' },
          enabled: true,
          reasonCode: 'PRICE_CHANGE'
        }
      },
