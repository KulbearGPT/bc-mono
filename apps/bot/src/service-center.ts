...
export type DiscordPresenceSummary =
...
export function buildDispatchIneligibleReply(
  workbench: PlayerWorkbenchSummary,
  requestId: string,
): string {
...
export interface BotApiClient {
  listServices(
    ...
    game?: string,
  ): Promise<{ items: PublicServiceSummary[] }>;
  createOrder(
  ...
  getCurrentUserProfileSummary(
    actor: BotActorContext,
  ): Promise<CurrentUserProfileSummary>;
  listCurrentUserOrders(
    actor: BotActorContext,
    cursor?: string,
    limit?: number,
  ): Promise<CurrentUserOrderPage>;
  listCurrentUserConsumptions(
    actor: BotActorContext,
    cursor?: string,
    limit?: number,
  ...
  getCurrentPlayerWeeklyReport(
    reportId: string,
    actor: BotActorContext,
  ): Promise<CurrentPlayerWeeklyReport>;
  listCurrentUserCommissions(
    actor: BotActorContext,
  ): Promise<CurrentCommissionPage>;
  estimateOrder(
    orderId: string,
...
export class HttpBotApiClient implements BotApiClient {
  ...
  public async recoverOrderChannel(
    ...
    return this.request<OrderSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/channel-recovery`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async addOrderRequirement(
    ...
    return this.request<OrderRequirementMutationSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/requirements`,
  ...
  public async listServicePackages(
    ...
    return this.request<ServicePackagePageSummary>(
      `/api/v1/service-packages?${query.toString()}`,
      { method: "GET", actor },
    );
  }
  ...
  public async applyServicePackage(
    ...
    return this.request<ApplyServicePackageSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/package`,
      { method: "POST", actor, idempotencyKey, body: input },
    );
  }
  ...
  public async getCurrentUserProfileSummary(
    actor: BotActorContext,
  ): Promise<CurrentUserProfileSummary> {
  ...
  public async listCurrentUserOrders(
    ...
    return this.request<CurrentUserOrderPage>(
      pagePath("/api/v1/me/orders", cursor, limit),
      { method: "GET", actor },
    );
  }
  ...
  public async listGifts(
    orderId: string,
    actor: BotActorContext,
  ): Promise<GiftPanelData> {
    return this.request<GiftPanelData>(
      `/api/v1/gifts?orderId=${encodeURIComponent(orderId)}`,
      {
        method: "GET",
        actor,
      },
  ...
  public async checkGiftAffordability(
    ...
    return this.request<GiftAffordabilityResult>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/gift-affordability`,
      {
        method: "POST",
        actor,
  ...
  public async createOrderGiftRequest(
    ...
    return this.request<GiftRequestResult>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/gift-requests`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async createOrderAppeal(
    ...
    return this.request(
      `/api/v1/orders/${encodeURIComponent(orderId)}/staff-tasks`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async listCurrentPlayerWeeklyReports(
    ...
    return this.request<CurrentPlayerWeeklyReportPage>(
      pagePath("/api/v1/players/me/weekly-reports", cursor, limit),
      { method: "GET", actor },
    );
  }
  ...
  public async listCurrentUserCommissions(
    actor: BotActorContext,
  ): Promise<CurrentCommissionPage> {
  ...
  public async estimateOrder(
    ...
    return this.request<OrderEstimateSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/estimate`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async submitOrder(
    ...
    return this.request<OrderReservationSummaryResult>(
  ...
  public async cancelOrder(
    ...
    return this.request<CancellationResultSummary>(
  ...
  public async acceptOrder(
    ...
    return this.request<OrderSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/accept`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async declineOrderOffer(
    ...
    return this.request<OrderSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/decline`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async setOrderReadiness(
    ...
    return this.request<OrderLifecyclePanelSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/readiness`,
      {
        method: "PUT",
        actor,
        idempotencyKey,
  ...
  public async requestOrderCompletion(
    ...
    return this.request<CompletionRequestSummary>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/request-completion`,
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async confirmOrder(
    ...
    return this.request<OrderCompletionSummary>(
  ...
  public async syncDiscordPresence(
    ...
    return this.request<PresenceSyncResult>(
      "/api/v1/internal/discord/presence",
      {
        method: "POST",
        actor,
        idempotencyKey,
  ...
  public async getPlayerWorkbench(
    actor: BotActorContext,
  ): Promise<PlayerWorkbenchSummary> {
    return this.request<PlayerWorkbenchSummary>(
      "/api/v1/players/me/workbench",
      { method: "GET", actor },
    );
  }
  ...
  public createSelectionPool(
    ...
    return this.request<SelectionPoolResult>(
      `/api/v1/orders/${encodeURIComponent(orderId)}/selection-pools`,
      { method: "POST", actor, idempotencyKey, body: input },
    );
  }
  ...
  public listSelectionApplications(
    orderId: string,
    poolId: string,
    actor: BotActorContext,
    cursor?: string,
...
function paginationCustomId(prefix: string, cursor: string): string {
  if (!/^c1_[A-Za-z0-9_-]{20,70}$/u.test(cursor))
    throw new Error("API pagination cursor is invalid.");
  const customId = `${prefix}:${cursor}`;
  if (customId.length > 100)
    throw new Error("Discord pagination custom ID exceeds 100 characters.");
  return customId;
}
...
export type MessageComponentSpec =
  ActionRowSpec | V2SectionSpec | V2TextSpec | V2SeparatorSpec;
...
export function buildOrderPanelMessage(
  ...
  if (
    (order.status === "PENDING_DISPATCH" || order.status === "ACCEPTED") &&
    order.matching
  ) {
  ...
  const selectedService = services.find(
    (service) => service.id === order.serviceCatalogId,
  );
  const body = [
...
export function buildMultiProjectOrderPanelMessage(
  ...
  const groups = [
    ...new Map(
      requirements.map((item) => [item.game, item.gameDisplayName]),
    ).entries(),
  ];
        ...
        components: [
          select(
            ...
            integerOptions(
              ...
              12,
              selected.unitCount,
              (value) => `${(value * selected.billingUnitMinutes) / 60} 小时`,
            ),
          ),
        ],
      },
...
export function buildServicePackagePickerMessage(
  order: OrderSummary,
  page: ServicePackagePageSummary,
): MessageSpec {
  return {
                ...
                select(
                  ...
                  page.items
                    ...
                    .map((item) => ({
                      ...
                      value: item.id,
                      description:
                        `${item.slots.length} 个席位 · ${item.description}`.slice(
                          0,
                          100,
                        ),
                    })),
...
export function buildGamePickerMessage(
  ...
  const games = [
    ...new Map(
      services.map((item) => [item.game, item.gameDisplayName ?? item.game]),
    ).entries(),
  ].slice(0, 20);
...
export function buildGameOrderingMenuMessage(
  ...
  const gameName =
    services[0]?.gameDisplayName ?? packages.items[0]?.gameDisplayName ?? game;
  const components: MessageComponentSpec[] = packages.items
    .slice(0, 20)
    .map((item) => ({
      type: "V2_SECTION",
  ...
  if (services.length)
    components.push({
      ...
      components: [
        select(
          `bc:req:${order.id}:preview:v${order.version}`,
          "选择一个单点陪玩项目",
          serviceOptions(order, services),
        ),
      ],
    });
  if (selectedService)
...
export function buildServicePackagePreviewMessage(
  order: OrderSummary,
  pkg: ServicePackagePreviewSummary,
): MessageSpec {
...
export async function handleServicePackageAction(input: {
  ...
  if (input.action === "preview") {
    if (!input.servicePackageVersionId)
...
function buildPausedAutomationMessage(order: OrderSummary): MessageSpec {
  return {
    ...
    body: [
      ...
      order.automation?.expiresAt
        ? botCopy.orders.reviewExpectedAt(order.automation.expiresAt)
        : null,
    ]
      .filter(Boolean)
      .join("\n"),
...
export function buildMatchingProgressMessage(order: OrderSummary): MessageSpec {
  ...
  const remainingPlayerCount = hasAssemblyProgress
    ? Math.max(
        0,
        Number(matching.requestedPlayerCount) -
          Number(matching.filledPlayerCount),
      )
    : null;
  return {
    ...
    body: [
      ...
      hasAssemblyProgress
        ? `陪玩到位：${matching.filledPlayerCount}/${matching.requestedPlayerCount}`
        : null,
...
export function buildServiceCenterMessage(input: {
  ...
  const consumptionLine =
    input.consumptions.items.length === 0
      ? "消费记录：暂无记录"
      : "消费记录：已有记录";
    ...
    components: [
      {
        ...
        components: [
          ...
          },
          {
            type: "BUTTON",
            style: "PRIMARY",
            customId: input.activeOrder
              ? `bc:order:${input.activeOrder.id}:open`
              : "bc:service-center:no-active-order",
            label: "当前订单",
...
export function buildCurrentWalletMessage(
  balance: BalanceSummary,
): MessageSpec {
  return {
...
export function buildCurrentUserProfileMessage(
  input: CurrentUserProfileSummary,
): MessageSpec {
  ...
  return {
    ...
    body: page.items.length
      ? page.items
          .map(
            (item) =>
              `${item.periodStart} 至 ${item.periodEnd} · ${item.status}`,
          )
          .join("\n")
      : "暂无周报。",
    visibility: "EPHEMERAL",
        ...
        })),
      {
        ...
        components: [
          ...
          },
          {
            ...
            style: "PRIMARY",
            customId: page.nextCursor
              ? paginationCustomId("bc:reports:list", page.nextCursor)
              : "bc:reports:list:end",
            label: "下一页",
            disabled: !page.nextCursor,
          },
...
export function buildCurrentPlayerWeeklyReportDetailMessage(
  report: CurrentPlayerWeeklyReport,
): MessageSpec {
...
export function buildCancellationPreviewMessage(
  preview: CancellationPreviewSummary,
): MessageSpec {
...
export function buildPlayerWorkbenchMessage(
  workbench: PlayerWorkbenchSummary,
): MessageSpec {
  const currentOrder = workbench.currentOrder
    ...
    : "当前订单：暂无";
  const matchingLines =
    "可报名候选池：请查看派单频道；报名不会占用正式订单名额。";
  const failedChecks = workbench.eligibility.checks.filter(
    (check) => !check.passed,
  );
...
export function buildDispatchOfferMessage(
  input: DispatchOfferSummary,
): MessageSpec {
  return {
...
export function buildServiceLifecyclePanelMessage(
  order: OrderLifecyclePanelSummary,
): MessageSpec {
  const giftsEnabled =
    Array.isArray(order.enabledFeatures) &&
    order.enabledFeatures.includes("GIFTS");
  if (order.status === "ACCEPTED") {
    return {
      ...
      body: [
        ...
        order.readiness.readyDeadlineAt
          ? `就绪截止：${order.readiness.readyDeadlineAt}`
          : null,
      ]
        .filter(Boolean)
        .join("\n"),
  ...
  if (order.status === "IN_SERVICE") {
    const components: ComponentSpec[] = orderMenuControls(
      order.orderId,
      order.version,
    );
...
export function buildOrderConfirmationMessage(input: {
  ...
  const deficitMinor = Math.max(
    0,
    input.estimate.amountMinor - input.balance.availableMinor,
  );
  const canSubmit =
    missing.length === 0 && deficitMinor === 0 && !currencyMismatch;
...
export function buildMultiProjectOrderConfirmationMessage(input: {
  ...
  const active = input.requirements.items.filter(
    (item) => item.status === "ACTIVE",
  );
  const currencyMismatch =
    input.requirements.currency !== input.balance.currency;
  const deficitMinor = Math.max(
    0,
    input.requirements.derivedTotalMinor - input.balance.availableMinor,
  );
  const canSubmit =
    active.length > 0 && !currencyMismatch && deficitMinor === 0;
  const lines = active
    .map(
      (item, index) =>
...
export function buildSubmittedOrderMessage(
  input: OrderReservationSummaryResult,
): MessageSpec {
  return {
    title: "订单已提交 · 正在匹配陪玩",
    body: [
...
export function buildCancellationResultMessage(
  input: CancellationResultSummary,
): MessageSpec {
  ...
  try {
    if (input.api.listOrderRequirements) {
      const [requirements, balance] = await Promise.all([
        input.api.listOrderRequirements(
          input.orderId,
          input.actor,
          undefined,
          25,
...
export async function handleServiceLifecycleAction(input: {
  ...
  try {
    ...
    if (input.action === "confirm") {
      ...
      return {
        kind: "EPHEMERAL_MESSAGE",
        message: botCopy.lifecycle.completionConfirmed(
          formatCustomerMoney(result.capturedMinor, result.currency),
        ),
      };
    }
    ...
    if (isApiError(error, "PERMISSION_DENIED")) {
      return {
        kind: "EPHEMERAL_MESSAGE",
        message: lifecyclePermissionDeniedMessage(
          input.action,
          requestId(error),
        ),
      };
  ...
  try {
    ...
    const [balance, consumptions, commissions, activeOrder] = await Promise.all(
      [
        ...
        currentUser.activeOrderId
          ? input.api.getOrder(currentUser.activeOrderId, input.actor)
    ...
    if (
      isApiError(error, "ACCOUNT_NOT_BOUND") ||
      isApiError(error, "AUTH_REQUIRED")
    ) {
      return {
        kind: "EPHEMERAL_MESSAGE",
...
export async function handleConfirmCancellation(input: {
  ...
  try {
    ...
    return {
      kind: "EPHEMERAL_MESSAGE",
      message: result.staffTaskId
        ? BOT_COPY.orders.cancellationEscalated
        : BOT_COPY.orders.cancellationCompleted,
    };
  } catch (error) {
    if (
      error instanceof BotApiError &&
      error.code === "CANCELLATION_PREVIEW_STALE"
    ) {
      return {
        kind: "EPHEMERAL_MESSAGE",
...
export async function handleOrderSelectSubmit(input: {
  ...
  if(input.field==='preferred-players') {
    const updated = await input.api.updateOrder(
      ...
      {
        expectedVersion: input.expectedVersion,
        preferredPlayerDiscordUserIds: Array.isArray(input.value)
          ? input.value
          : [input.value],
      },
      input.actor,
    ...
    if (input.api.listOrderRequirements) {
      const page = await input.api.listOrderRequirements(
        input.orderId,
        input.actor,
        undefined,
        10,
  ...
  if (!selected)
    throw new Error("The selected service catalog is unavailable.");
...
export async function handleOrderRequirementSelectSubmit(input: {
  ...
  if (input.action === "preview") {
    ...
    if (!selected)
      throw new Error("The selected service catalog is unavailable.");
    const packages = await requirePackageApi(input.api).list(
      input.actor,
      undefined,
      25,
      selected.game,
  ...
  let selectedRequirementId =
    input.action === "edit" ? input.value : input.requirementId;
  ...
  if (input.action === "add") {
    ...
    if (!service)
      throw new Error("The selected service catalog is unavailable.");
    const created = await requirementApi.add(
      input.orderId,
      {
        expectedOrderVersion: input.expectedVersion,
    ...
    input.action === "units" ||
    input.action === "players"
  ) {
    const requirement = page.items.find(
      (item) => item.id === input.requirementId && item.status === "ACTIVE",
    );
    const requirementVersion =
      requirement?.version ?? input.expectedRequirementVersion;
    if (!input.requirementId || !requirementVersion)
      throw new Error("The selected order requirement is unavailable.");
    const quantity =
      input.action === "project" ? null : Number.parseInt(input.value, 10);
    if (
      input.action !== "project" &&
    ...
    const changed = await requirementApi.update(
      ...
      input.requirementId,
      {
        ...
        action:
          input.action === "project" ? "CHANGE_PROJECT" : "CHANGE_QUANTITY",
        serviceCatalogVersionId:
          input.action === "project" ? input.value : null,
        unitCount: input.action === "units" ? Number(quantity) : null,
        requestedPlayerCount:
          input.action === "players" ? Number(quantity) : null,
      },
      input.actor,
      input.idempotencyKey,
    );
...
export function parseServiceCenterCustomId(
  ...
  const giftAction =
    /^bc:gift:(select|refresh|confirm|back):(g1_[A-Za-z0-9_-]{80})$/u.exec(
      customId,
    );
  if (giftAction)
    return {
  ...
  const giftRecipients =
    /^bc:grs:([0-9a-f-]{36}):([0-9]+):v([1-9][0-9]*):([A-Za-z0-9_-]{1,40})$/u.exec(
      customId,
    );
  if (giftRecipients)
    return {
  ...
  if (giftCatalog)
    return { area: "gift-catalog-select", selection: giftCatalog[1]! };
  const giftRecipientPage =
    /^bc:grp:([0-9a-f-]{36}):([0-9]+):v([1-9][0-9]*):([A-Za-z0-9_-]{1,40})$/u.exec(
      customId,
    );
  ...
  const profilePage =
    /^bc:profile:(orders|consumptions):(first|end|c1_[A-Za-z0-9_-]{20,70})$/u.exec(
      customId,
    );
  if (profilePage) {
    return {
      ...
      cursor:
        profilePage[2] === "first" || profilePage[2] === "end"
          ? undefined
          : profilePage[2],
    };
  }
  const reportList =
    /^bc:reports:list:(first|end|c1_[A-Za-z0-9_-]{20,70})$/u.exec(customId);
  if (reportList) {
    return {
      area: "reports",
      action: "list",
      cursor:
        reportList[1] === "first" || reportList[1] === "end"
          ? undefined
          : reportList[1],
    };
  }
  ...
  if (reportDetail)
    return { area: "reports", action: "detail", reportId: reportDetail[1] };
  ...
  const cancellationAction =
    /^bc:cancel:([0-9a-f-]{36}):([0-9a-f-]{36}):confirm:v([1-9][0-9]*)$/u.exec(
      customId,
    );
  ...
  const orderSelect =
    /^bc:select:order:([0-9a-f-]{36}):(catalog|duration|preferred-players):v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (orderSelect) {
    return {
  ...
  const requirementAdd =
    /^bc:req:([0-9a-f-]{36}):(add|preview):v([1-9][0-9]*)$/u.exec(customId);
  if (requirementAdd)
    return {
      area: "order-requirement-select",
  ...
  const requirementEdit =
    /^bc:req:([0-9a-f-]{36}):edit:(first|[A-Za-z0-9_-]{1,40}):v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (requirementEdit)
    return {
  ...
  const requirementQuantity =
    /^bc:req:([0-9a-f-]{36}):([0-9a-f-]{36}):(project|units|players):v([1-9][0-9]*):r([1-9][0-9]*)$/u.exec(
      customId,
    );
  ...
  const requirementRemove =
    /^bc:req:([0-9a-f-]{36}):([0-9a-f-]{36}):remove:v([1-9][0-9]*):r([1-9][0-9]*)$/u.exec(
      customId,
    );
  ...
  const requirementAddAction =
    /^bc:req:([0-9a-f-]{36}):([0-9a-f-]{36}):add:v([1-9][0-9]*)$/u.exec(
      customId,
    );
  ...
  const requirementBack = /^bc:req:([0-9a-f-]{36}):back:v([1-9][0-9]*)$/u.exec(
    customId,
  );
  if (requirementBack)
    return {
  ...
  const requirementPage =
    /^bc:req:([0-9a-f-]{36}):page:(first|[A-Za-z0-9_-]{1,40}):v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (requirementPage)
    return {
  ...
  const packageSelect =
    /^bc:package:([0-9a-f-]{36}):select:v([1-9][0-9]*)$/u.exec(customId);
  if (packageSelect)
    return {
  ...
  const gameSelect = /^bc:game:([0-9a-f-]{36}):select:v([1-9][0-9]*)$/u.exec(
    customId,
  );
  if (gameSelect)
    return {
  ...
  const gameAction =
    /^bc:game:([0-9a-f-]{36}):([A-Z0-9_]{1,24}):open:v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (gameAction)
    return {
  ...
  const packagePreview =
    /^bc:package:([0-9a-f-]{36}):([0-9a-f-]{36}):preview:v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (packagePreview)
    return {
  ...
  const packageApply =
    /^bc:package:([0-9a-f-]{36}):([0-9a-f-]{36}):apply:v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (packageApply)
    return {
  ...
  const packageAction =
    /^bc:package:([0-9a-f-]{36}):(open|back):v([1-9][0-9]*)$/u.exec(customId);
  if (packageAction)
    return {
      area: "service-package-action",
  ...
  const notesModal =
    /^bc:modal:order-notes:([0-9a-f-]{36}):v([1-9][0-9]*)$/u.exec(customId);
  if (notesModal) {
    return {
  ...
  const notesOpen =
    /^bc:modal-open:order-notes:([0-9a-f-]{36}):v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (notesOpen)
    return {
  ...
  const requirementNoteModal =
    /^bc:rnm:([0-9a-f-]{36}):([0-9a-f-]{36}):v([1-9][0-9]*):r([1-9][0-9]*)$/u.exec(
      customId,
    );
  ...
  const requirementNoteOpen =
    /^bc:rno:([0-9a-f-]{36}):([0-9a-f-]{36}):v([1-9][0-9]*):r([1-9][0-9]*)$/u.exec(
      customId,
    );
  ...
  const orderAction =
    /^bc:order:([0-9a-f-]{36}):(submit|submit-final|cancel):v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (orderAction) {
    return {
  ...
  const serviceAction =
    /^bc:service:(ready|request-completion|confirm|support):([0-9a-f-]{36}):v([1-9][0-9]*)$/u.exec(
      customId,
    );
  if (serviceAction) {
    return {
      ...
      action: serviceAction[1] as
        "ready" | "request-completion" | "confirm" | "support",
...
export function buildDiscordIdempotencyKey(
  ...
  return `discord:${action}:${interactionId}`
...
function requirementOptions(
  ...
  if (!requirements.length)
    return [{ label: "还没有项目", value: "unavailable" }];
  return requirements
    .slice(0, 25)
    .map((item, index) => ({
      label:
...
function integerOptions(
  ...
  return [...values]
    ...
    .slice(0, 25)
    .map((value) => ({
      label: `${label(value)}${value === current ? " · 当前" : ""}`.slice(
        0,
        100,
      ),
      value: String(value),
...
function requireOrderRequirementApi(api: BotApiClient) {
  if (
    !api.listOrderRequirements ||
    !api.addOrderRequirement ||
    !api.updateOrderRequirement
  )
    throw new Error("Order requirement API is unavailable.");
  return {
...
function requirePackageApi(api: BotApiClient) {
  if (
    !api.listServicePackages ||
    !api.previewServicePackage ||
    !api.applyServicePackage
  )
...
function serviceOptions(
  ...
  if (order.serviceCatalogId)
    return [
      {
        label: `${order.game ?? "陪玩"} · ${order.service ?? "服务"}`.slice(
          0,
          100,
        ),
...
function lifecyclePermissionDeniedMessage(
  ...
  if (action === "request-completion")
    return botCopy.lifecycle.completionRequestRestricted(id);
...
function formatPlatformMoney(amountMinor: number, currency: string): string {
  if (currency === "CAT")
    return formatCustomerWalletAmount(
      amountMinor,
...
function formatCustomerMoney(amountMinor: number, currency: string): string {
  if (currency !== "CAT")
    throw new Error("Customer wallet display requires canonical CAT subunits.");
  return formatCustomerWalletAmount(
    amountMinor,
    parseWalletDisplayConfig(process.env),
  );
