...
function buildDispatchOutboxJobs(input: {
  ...
  const basePayload = {
    ...
    game: input.orderRequirement?.gameDisplayName ?? input.orderRequirement?.game ?? input.order.gameDisplayName ?? input.order.game,
    service: input.orderRequirement?.serviceDisplayName ?? input.orderRequirement?.service ?? input.order.serviceDisplayName ?? input.order.service,
    region: input.orderRequirement?.regionDisplayName ?? input.orderRequirement?.region ?? input.order.regionDisplayName ?? input.order.region,
