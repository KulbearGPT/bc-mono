...
const permissionsByMinimumLevel: Record<StaffLevel, readonly string[]> = {
  L1_SUPPORT: ['staff.session.active', 'mfa.manage_self', 'step_up.execute', 'dashboard.view', 'staff_task.read', 'staff_task.claim', 'staff_task.verify', 'order.read', 'order.participants.manage', 'order.pause', 'gift_request.read', 'audit.read', 'customer_profile.read', 'customer_profile.note.append', 'wallet.read'],
